...
success_combined_plots <- ggarrange(success_imprecision_barplot, success_Polarization_barplot, ncol=2, nrow=1, common.legend = TRUE, legend="top")
...
judgment_combined_plots <- ggarrange(judgment_imprecision_barplot, judgment_Polarization_barplot, ncol=2, nrow=1, common.legend = TRUE, legend="top")
...
reception_combined_plots <- ggarrange(reception_imprecision_barplot, reception_Polarization_barplot, ncol=2, nrow=1, common.legend = TRUE, legend="top")
