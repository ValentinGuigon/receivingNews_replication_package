...
We compute Bayesian Mixed Linear Models (MLM) for our main hypothesis on participants' performances
in estimating veracity, as well as alternative models. Computations use 4 mcmc chains, 4000 iterations each plus 1500 warmup iterations each. We use weakly informative priors with 
...
Finally, we computed the model of stickiness of prior knowledge:
```{r, echo=FALSE}
...
The Bayesian Mixed Linear Model that explains best participants' performances is the 
model of news content imprecision & Polarization with both variables interacting with news veracity.
...
>>>>>>> e1e3bd4692dad8f82a3decbbc19e654e540b9472
