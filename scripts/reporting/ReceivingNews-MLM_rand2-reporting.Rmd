...
df = data.frame(yAxis = length(boxLabels):1, 
                boxOdds = estSuccess_truth_imprec_ci$odds.ratio, 
                boxCILow = estSuccess_truth_imprec_ci$asymp.LCL, 
                boxCIHigh = estSuccess_truth_imprec_ci$asymp.UCL, 
                boxLabels = boxLabels)
...
boxLabels <- c("True", "False")
df = data.frame(yAxis = length(boxLabels):1, 
                boxOdds = estSuccess_truth_polar_ci$odds.ratio, 
                boxCILow = estSuccess_truth_polar_ci$asymp.LCL, 
                boxCIHigh = estSuccess_truth_polar_ci$asymp.UCL, 
                boxLabels = boxLabels)
...
boxLabels <- c("True", "False")
df = data.frame(yAxis = length(boxLabels):1, 
                boxOdds = estJudgment_truth_imprec_ci$odds.ratio, 
                boxCILow = estJudgment_truth_imprec_ci$asymp.LCL, 
                boxCIHigh = estJudgment_truth_imprec_ci$asymp.UCL, 
                boxLabels = boxLabels)
...
boxLabels <- c("True", "False")
df = data.frame(yAxis = length(boxLabels):1, 
                boxOdds = estJudgment_truth_polar_ci$odds.ratio, 
                boxCILow = estJudgment_truth_polar_ci$asymp.LCL, 
                boxCIHigh = estJudgment_truth_polar_ci$asymp.UCL, 
                boxLabels = boxLabels)
...
df = data.frame(yAxis = length(boxLabels):1, 
                boxOdds = estRec_judgment_confidence_ci$odds.ratio, 
                boxCILow = estRec_judgment_confidence_ci$asymp.LCL, 
                boxCIHigh = estRec_judgment_confidence_ci$asymp.UCL, 
                boxLabels = boxLabels)
