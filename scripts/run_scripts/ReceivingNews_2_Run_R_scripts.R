...
source("./scripts/analysis/ReceivingNews-Mixed_Linear_Models_main_rand2.R")
source("./scripts/analysis/ReceivingNews-Mixed_Linear_Models_alternatives_rand2.R")
...
rmarkdown::render("./scripts/reporting/ReceivingNews-MLM_rand2-reporting.Rmd",output_dir = paste(project_root, "/outputs/reports", sep=""))
